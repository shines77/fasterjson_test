...
/* 根据timestamp起始值得出流逝时间的毫秒值, 单位: 毫秒(millisecond), 返回值: int64_t. */
JMC_INLINE
...
/* 根据timestamp起始值得出流逝时间的毫秒值, 单位: 毫秒(millisecond), 返回值: 浮点值. */
JMC_INLINE
...
/* 根据timestamp起始值得出流逝时间的秒数, 单位: 秒(second), 返回值: 浮点值. */
JMC_INLINE
